...
public class CardPilesAdapter extends RecyclerView.Adapter<CardPileTopViewHolder>
{
    ...
    //UPDATE TO ABOVE FIELDS - please add this field, not shown in the video:
    private final boolean mIS_NIGHT_MODE;

    // If user wants to disable animations then they can call the setter below from MainActivity
